...
namespace ATMC.App.KMC.H5.HoodInstall {
    ...
    //================================================
    public enum OutputPin { OK, NG, PCRUN, HW_ERR, AUTO }
    public enum InputPin { RESET, START, SCAN, END }
    ...
    internal static partial class Global {
        ...
        public const string KEY_BODY12 = "body12";
        ...
        public static void InitActions() {
            ...
            ScanActionList = new List<ScanAction> {
                ...
                new ScanAction(KEY_BODY2, Scan_S2R1),
            };

            ScanActionDict = ScanActionList.ToActionDict();

            ScanActionGroups = new List<ScanActionGroup> { 
                new ScanActionGroup(name:KEY_BODY12,actions:ScanActionDict.GetActionList(KEY_BODY1,KEY_BODY2),combine:true),
            };
        }
    }
    ...
    public partial class FormMain {
        async Task DO_SCAN()
        {
            ...
            string key;
            string signal = ""; //just OK,NG
            string action_key1;
            string action_key2;
            action_key1 = Global.KEY_BODY1;
            action_key2 = Global.KEY_BODY2;
            key = Global.KEY_BODY12;
        ...
        void ProcessInputSignal(string signal_name) {
            try {
                ...
                switch(key) {
                    ...
                    case InputPin.SCAN: _tq.Enqueue(async () => await DO_SCAN()); break;
